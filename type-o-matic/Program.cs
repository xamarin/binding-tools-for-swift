...
namespace typeomatic {
	class MainClass {
		static string kMetadataToolsDirectory = "../../../tools/";
		...
		public static int Main (string [] args)
		{
			...
			if (!Directory.Exists (targetDirectory)) {
	    		...
	    		if (!Directory.Exists (kMetadataToolsDirectory)) {
				Console.WriteLine ($"Unable to find metadata tools directory {kMetadataToolsDirectory}");
				return 1;
			}
